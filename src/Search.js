...
class Search extends Component {
  ...
  componentDidMount() {
    $.ajax({
      method: 'post',
      url: 'http://data.orghunter.com/v1/categories?user_key=3bf0ab40cbe750cb184fef3e0e504c16'
    })
    .done((response) => {
      this.setState({
  ...
  callApi = () => {
    ...
    $.ajax({
      method: 'post',
      url: 'http://data.orghunter.com/v1/charitysearch?user_key=3bf0ab40cbe750cb184fef3e0e504c16&category=' + this.state.selectedCategory + '&state=' + this.state.selectedState
    })
    .done((response) => {
  ...
  getDetails = (e, ein) => {
    $.ajax({
      method: 'get',
      url: `http://data.orghunter.com/v1/charitybasic?user_key=3bf0ab40cbe750cb184fef3e0e504c16&ein=${ein}`
    })
    .done((response) => {
      console.log(response)
      this.setState({
